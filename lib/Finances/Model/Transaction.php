...
class Transaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'payout_id' => 'string',
        'references' => '\Ebay\Sell\Finances\Model\Reference[]',
     ...
     * Gets references
     *
     * @return \Ebay\Sell\Finances\Model\Reference[]|null
     */
     ...
     * Sets references
     *
     * @param \Ebay\Sell\Finances\Model\Reference[]|null $references This field contains reference information for the transaction fee. This includes an ID and the type of ID provided (such as item ID).
     *
     * @return self
     */
